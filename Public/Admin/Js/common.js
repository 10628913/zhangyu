$(function	()	{
	...
	//Collapsible Sidebar Menu 	document.cookie="name=1212";
...
//
function openItem(menuId,url){
	$(".main-menu ul.submenu a").removeClass("selected");
	$("#menu-"+menuId).addClass("selected");
	$("#content-wrapper").attr('src', url);
	$.get("?m=Admin&c=index&a=getCurrentPos&menuId="+menuId, function(data){
